...
function drawTexts(ctx: CanvasRenderingContext2D, data: CnhMeioData, s: number = 1): void {
  ...
  const catPositions: Record<string, Array<{ x: number; y: number }>> = {
    'A':  [{ x: 412, y: 111 }],
    'B':  [{ x: 412, y: 177 }],
    'AB': [{ x: 412, y: 111 }, { x: 412, y: 177 }],
    'AC': [{ x: 412, y: 111 }, { x: 412, y: 177 }, { x: 412, y: 243 }],
    'C':  [{ x: 412, y: 177 }, { x: 412, y: 243 }],
    'AD': [{ x: 412, y: 111 }, { x: 412, y: 177 }, { x: 412, y: 243 }, { x: 816, y: 79 }],
    'D':  [{ x: 412, y: 177 }, { x: 410, y: 240 }, { x: 816, y: 79 }],
	         //A                           // B           //C                //D              //BE                //CE              
    'AE': [{ x: 412, y: 111 }, { x: 412, y: 177 }, { x: 412, y: 243 }, { x: 816, y: 79 }, { x: 816, y: 145 }, { x: 816, y: 177 }, 
	
	//DE
	{ x: 816, y: 243 }],
    'E':  [{ x: 412, y: 177 }, { x: 412, y: 243 }, { x: 816, y: 79 }, { x: 816, y: 243 }],
  };
